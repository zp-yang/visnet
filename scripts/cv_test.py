...
class GzbObjTracker:
  ...
  def __init__(self, tracker_name=None, blob_params=None, subtractor_name=None, buffer_size=2):
    ...
    # these are for the motion detection
  ...
  def obj_detect(self, frame):
    ...
    cv2.putText(orig_frame, self.subtractor_name + " Subtractor", (100,20), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50,170,50),2)

    # Display FPS on frame
    cv2.putText(orig_frame, "FPS : " + str(int(fps)), (100,50), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (50,170,50), 2)
